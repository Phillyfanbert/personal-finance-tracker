#!/usr/bin/env bash
# ============================================================================
# One-shot SERVER MACHINE bootstrap - run this ON hosts-macbook-pro (or
...
if [ -f "$ENV_FILE" ]; then
  ...
  read -r -p "Supabase project URL [https://ixosipgbikygqilbgvjx.supabase.co]: " SB_URL
  SB_URL="${SB_URL:-https://ixosipgbikygqilbgvjx.supabase.co}"
